...
import { getCurrentAuthUser, UserData, updateBadges as updateBadgesAndTreesCount } from "../../../lib/firebaseServices";
import { FormValues } from "../addTreeForm";

export async function updateBadgesAfterAddingTree(formValues: FormValues,
                                                user: UserData,
