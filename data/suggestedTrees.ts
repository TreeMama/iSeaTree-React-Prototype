...
export const suggestedTrees: SuggestedTreeData[] = [
  {
    ...
    known_public_locations: [
      "At Discovery Park, Seattle, on the Loop Trail there are two very large trees (~100 ft tall)."
    ],
    fun_facts: [
  ...
  },
  {
    ...
    known_public_locations: [
      "Green Lake, Seattle: the largest Coast Redwood is located in the golf course area (~110 feet tall).",
      "Viretta Park, Seattle (39th Ave E & Evergreen Place), is home to a Redwood that is approximately 135 feet tall."
    ],
    fun_facts: [
  ...
  },
  {
    ...
    known_public_locations: [
      "Denny Park is home to a few giants who are over 200 feet tall.",
      "Notable trees with huge trunks can be found in Carkeek Park, Golden Gardens, and Seward Park."
    ],
    fun_facts: [
  ...
  }, 
  {
    ...
    known_public_locations: ['Ravenna Park: east of the 15th Ave NE bridge.'],
    fun_facts: [
  ...
  },
  {
    ...
    known_public_locations: [
      `Hiram M. Chittenden Locks / Carl S. English Jr. Botanical Garden.`,
      'Seward Park (look in the grove at the peninsula tip).',
      'Golden Gardens Park.'
    ],
    fun_facts: [
